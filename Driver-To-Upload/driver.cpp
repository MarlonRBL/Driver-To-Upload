...
#define code_rw CTL_CODE(FILE_DEVICE_UNKNOWN, 0x2455, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define code_ba CTL_CODE(FILE_DEVICE_UNKNOWN, 0x2456, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define code_get_guarded_region CTL_CODE(FILE_DEVICE_UNKNOWN, 0x2457, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define code_security 0x85b3e20
...
NTSTATUS initialize_driver(PDRIVER_OBJECT drv_obj, PUNICODE_STRING path) {
	...
	UNICODE_STRING name, link;
	RtlInitUnicodeString(&name, L"\\Device\\hdriver");
	RtlInitUnicodeString(&link, L"\\DosDevices\\hdriver");
